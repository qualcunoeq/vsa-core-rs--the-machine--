...
1. `adaptation_isolation`: medium/large/max adaptation in cleaner conditions.
2. `memory_scaling_ladder`: medium/large/max memory-pressure latency curve.
...
- Starts memory scaling when at least 30 tracked cores are free.
