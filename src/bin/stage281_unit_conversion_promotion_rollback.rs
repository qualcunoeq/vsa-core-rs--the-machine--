//! Stage 281: clone-only promotion and rollback for bounded unit conversion.
//!
//! This exercises the candidate lifecycle after independent validation while
//! keeping the production curriculum and router unchanged.
...
const REPORT_JSON: &str = "docs/stage281_unit_conversion_promotion_rollback.json";
const REPORT_MD: &str = "docs/stage281_unit_conversion_promotion_rollback.md";
...
fn candidate(scenario: Scenario) -> CurriculumPack {
    ...
    CurriculumPack {
        ...
        selection_reason: "fresh source-derived unit-conversion validation".into(),
    }
}
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let report = Report {
        schema: "stage281-unit-conversion-promotion-rollback-v1",
