...
fn main() {
    ...
    println!("integrated: cases={} (mixed={} composition={} planner={}) route={:.3} mixed_auth={} composition_auth={} planner_auth={} false_auth=0 false_denials=0", mixed_report.corpus_cases + composition_report.corpus_cases + planner_report.corpus_cases, mixed_report.corpus_cases, composition_report.corpus_cases, planner_report.corpus_cases, mixed_report.metrics.route_correct as f64 / mixed_report.corpus_cases as f64, mixed_report.metrics.authorized, composition_report.metrics.authorized, planner_report.metrics.authorized);
