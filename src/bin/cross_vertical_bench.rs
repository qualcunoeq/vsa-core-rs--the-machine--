...
fn main() {
    ...
    println!("rewrites: pairs={} decision_stable={} result_stable={} regressions={}", report.rewrites.pairs, report.rewrites.decision_stable, report.rewrites.result_stable, report.rewrites.regressions);
