...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    for index in 0..RECORDS {
        ...
        let record = MemoryRecord {
            record_id: format!("stage205-{index:06}"),
            domain: domain.clone(),
            ...
            provenance: vec![
                ...
                "stage205-current-manifest-memory".into(),
            ],
    ...
    let report = Report {
        schema: "stage205-current-manifest-memory-after-mobius-v1",
        manifest_sha256,
        validated_packs,
    ...
    println!(
        "stage205 packs={} descriptors={} records=100000 replay=100000 tamper=1000",
        report.validated_packs, report.descriptors
    );
    Ok(())
}
